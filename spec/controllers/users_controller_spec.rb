...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe "for signed in users" do
      ...
      it "should not have a delete links for normal users" do
        other_user = User.all.second
        get :index
  ...
  describe "GET 'show'" do
    ...
    it "should show the user's microposts" do
      mp1 = Factory(:micropost, :user => @user, :content => "Foo bars")
      mp2 = Factory(:micropost, :user => @user, :content => "Foo sdf fdsa222")
      get :show, :id => @user
    ...
    it "should paginate microposts" do
      35.times { Factory(:micropost, :user => @user, :content => "fooo barrrrs")}
      get :show, :id => @user
      response.should have_selector('div.pagination');
    end
  ...
  describe "POST 'create" do
    ...
    describe "success" do
      before(:each) do
        @attr = { :name => "Steven P", :email => "info@viper.com", :password => "spanky", :password_confirmation => "spanky"}
      end
  ...
  describe "GET 'edit'" do
    ...
    it "should have the gravatar link" do
      get :edit, :id => @user
  ...
  describe "PUT 'update'" do
    ...
    describe "success" do
      before(:each) do
        @attr = { :name => "Steve", :email => "inf@ex.com", :password => "barbar", :password_confirmation => "barbar" }
      end
